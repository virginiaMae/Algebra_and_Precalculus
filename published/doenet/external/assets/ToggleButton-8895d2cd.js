import { r as reactExports, j as jsx, F as Fragment, b as jsxs, s as styled, v as betterReactMathjax } from "./PageViewer-d914b069.js";
const Button = styled.button`
  ...
  &:focus {
    outline: 2px solid
      ${(props) => props.disabled ? "var(--mainGray)" : props.alert ? "var(--mainRed)" : "var(--mainBlue)"};
    outline-offset: 2px;
  }
`;
Button.defaultProps = {
...
function ToggleButton(props) {
  const [isSelected, setSelected] = reactExports.useState(
  ...
  if (props.value || props.icon) {
    ...
    if (props.value && props.valueHasLatex) {
      toggleButton.value = /* @__PURE__ */ jsx(betterReactMathjax.MathJax, { hideUntilTypeset: "first", inline: true, dynamic: true, children: toggleButton.value });
    }
  }
  if (isSelected === true) {
    if (!props.disabled) {
  ...
  function handleClick() {
    if (props.onClick)
      props.onClick(
        props.index !== null && props.index !== void 0 ? props.index : null
      );
  }
  if (props.label) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { style: container, children: [
    /* @__PURE__ */ jsx("p", { id: "toggle-button-label", style: label, children: label.value }),
    /* @__PURE__ */ jsxs(
      Button,
      {
