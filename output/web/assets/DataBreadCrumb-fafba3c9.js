...
import { u as useCourseChooserCrumb, a as useDashboardCrumb, d as useDataCrumb } from "./breadcrumbUtil-2c734bba.js";
...
function DataBreadCrumb() {
  const courseId = Recoil_index_20(searchParamAtomFamily("courseId"));
  let sectionId = Recoil_index_20(searchParamAtomFamily("sectionId"));
  if (sectionId == "") {
    sectionId = courseId;
  }
  ...
  return /* @__PURE__ */ jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsx("div", { children: "loading Breadcrumbs..." }), children: /* @__PURE__ */ jsx(
    BreadCrumb,
    {
