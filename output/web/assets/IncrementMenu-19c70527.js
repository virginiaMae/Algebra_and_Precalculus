import { r as reactExports, b as jsxs, j as jsx, s as styled, c as FontAwesomeIcon, bq as faAngleLeft, br as faAngleRight } from "./PageViewer-d914b069.js";
...
function Increment(props) {
  ...
  if (props.values || props.font) {
    decreaseIcon = /* @__PURE__ */ jsx(FontAwesomeIcon, { icon: faAngleLeft });
    increaseIcon = /* @__PURE__ */ jsx(FontAwesomeIcon, { icon: faAngleRight });
  }
  const values = props.values || props.font && FONT_SIZES || [];
  const [value, setValue] = reactExports.useState(props.value || 0);
  const [index, setIndex] = reactExports.useState(0);
  const incrementRef = reactExports.useRef(null);
  const textFieldRef = reactExports.useRef(null);
  const decrementRef = reactExports.useRef(null);
  ...
  return /* @__PURE__ */ jsxs(Container, { label: props.label, vertical: props.vertical, children: [
    props.label && /* @__PURE__ */ jsx(Label, { id: "increment-label", children: props.label }),
    props.label && props.vertical && /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx(IncrementContainer, { width: containerWidth, children: /* @__PURE__ */ jsxs(
      IncrementBox,
      {
        ref: containerRef,
