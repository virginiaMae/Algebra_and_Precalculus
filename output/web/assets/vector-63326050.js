...
const vector = React.memo(function Vector(props) {
  ...
  let vectorJXG = reactExports.useRef({});
  let point1JXG = reactExports.useRef({});
  let point2JXG = reactExports.useRef({});
  ...
  let headBeingDragged = reactExports.useRef(false);
  let tailBeingDragged = reactExports.useRef(false);
  let downOnPoint = reactExports.useRef(null);
  let headcoords = reactExports.useRef(null);
  let tailcoords = reactExports.useRef(null);
  ...
  let headDraggable = reactExports.useRef(true);
  let tailDraggable = reactExports.useRef(true);
