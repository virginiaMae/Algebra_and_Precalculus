import { j as jsx, r as reactExports } from "./PageViewer-d914b069.js";
import { B as BreadCrumb } from "./BreadCrumb-20c00d72.js";
import { u as useCourseChooserCrumb } from "./breadcrumbUtil-2c734bba.js";
...
function ChooserBreadCrumb() {
  const courseChooserCrumb = useCourseChooserCrumb();
  return /* @__PURE__ */ jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsx("div", { children: "loading Breadcrumbs..." }), children: /* @__PURE__ */ jsx(BreadCrumb, { crumbs: [courseChooserCrumb] }) });
}
export {
  ChooserBreadCrumb as default
};
