import { r as reactExports, j as jsx, F as Fragment, b as jsxs, s as styled } from "./PageViewer-d914b069.js";
const TextfieldStyling = styled.input`
  /* margin: 0px 4px 0px 0px; */
  height: 24px;
  width: ${(props) => props.width}; // Menu prop
  border: 2px solid
    ${(props) => props.disabled ? "var(--mainGray)" : props.alert ? "var(--mainRed)" : "var(--canvastext)"};
  font-family: Arial;
...
function Textfield(props) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { style: container, children: [
    /* @__PURE__ */ jsx("p", { style: label, id: "textfield-label", children: label.value }),
    /* @__PURE__ */ jsx(
      TextfieldStyling,
      {
