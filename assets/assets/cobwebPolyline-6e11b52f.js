import { R as React, bx as useDoenetRenderer, r as reactExports, bG as createFunctionFromDefinition, j as jsx, F as Fragment } from "./PageViewer-d914b069.js";
...
const cobwebPolyline = React.memo(function CobwebPolyline(props) {
  ...
  let diagonalJXG = reactExports.useRef(null);
  ...
  let previousNPoints = reactExports.useRef(null);
      ...
      if (validCoords) {
        ...
        if (SVs.numPoints > 0) {
          if (SVs.draggable) {
            ...
            pointsJXG.current[SVs.numPoints - 1].visPropCalc["visible"] = visible;
          }
        }
      } else {
