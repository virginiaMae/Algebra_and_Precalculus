import { ax as commonjsGlobal, o as Recoil_index_24, p as pageToolViewAtom, t as Recoil_index_20, W as searchParamAtomFamily, r as reactExports, j as jsx, F as Fragment, b as jsxs, B as Button, h as axios } from "./PageViewer-d914b069.js";
...
function WelcomeUMNPlacementExam() {
  const setPageToolView = Recoil_index_24(pageToolViewAtom);
  let doenetId = Recoil_index_20(searchParamAtomFamily("doenetId"));
  let extended = Recoil_index_20(searchParamAtomFamily("extended"));
  let [takenStatus, setTakenStatus] = reactExports.useState("Page Init");
  const [examName, setExamName] = reactExports.useState("Calculus Placement Exam");
  const [learnerFirstName, setLearnerFirstName] = reactExports.useState(null);
  const [learnerLastName, setLearnerLastName] = reactExports.useState(null);
  const [startWarningMessageOpen, setStartWarningMessageOpen] = reactExports.useState(false);
  if (!doenetId) {
  ...
  if (takenStatus == "Page Init") {
    ...
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("p", { children: "Redirecting to ongoing exam..." })
      }
    );
    ...
    return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("p", { children: "(part of results component) If you have questions email? (call help desk?) (will be someone to reset)" }),
          /* @__PURE__ */ jsx("p", { children: "Results component goes here." })
        ]
      }
    ) });
  }
  if (startWarningMessageOpen) {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("h2", { style: { textAlign: "center" }, children: "Are you sure you want to start the exam now?" }),
          /* @__PURE__ */ jsx("p", { style: { textAlign: "center" }, children: "The timer begins when you click yes." }),
          /* @__PURE__ */ jsx(
            "div",
            {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("h2", { style: { textAlign: "center" }, children: examName }),
        /* @__PURE__ */ jsx(
          "div",
          {
            style: { display: "flex", justifyContent: "center", padding: "5px" },
...
export {
  WelcomeUMNPlacementExam as default
};
