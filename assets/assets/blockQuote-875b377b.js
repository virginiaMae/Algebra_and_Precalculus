...
const blockQuote = React.memo(function Container(props) {
  ...
  return /* @__PURE__ */ jsx(VisibilitySensor, { partialVisibility: true, onChange: onChangeVisibility, children: /* @__PURE__ */ jsxs("blockquote", { id, children: [
